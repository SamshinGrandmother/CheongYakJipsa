package me.synn3r.jipsa.core.api.security.controller;
 ...
 * <h2>사용 방법</h2>
 * <ol>
 *   <li>Swagger UI에서 <code>GET /api/dev/security/token</code> API 실행</li>
 ...
 */
@Profile("dev")
@Tag(name = "Dev Security", description = "개발용 인증 API (dev 프로파일에서만 활성화)")
@RestController
